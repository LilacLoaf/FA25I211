 ...
 * 
 */
require_once dirname(__FILE__, 2) . '/application/database.class.php';
...
class MovieManager {
    ...
    private mysqli $dbConnection;  //Database connection
    private string $tblMovie;            //database table that stores all movies
    private string $tblMovieRating;      //database table that stores all movie ratings
    static private ?MovieManager $_instance = NULL;  //instance of the current class

    //the constructor. It initializes private data members. Please the constructor is private.
    ...
    public function search_movie($terms) {
        ...
        $sql = "SELECT * FROM " . $this->tblMovie . "," . $this->tblMovieRating .
            " WHERE " . $this->tblMovie . ".rating=" . $this->tblMovieRating . ".rating_id AND ";
