...
class MovieModel {
    ...
    static private ?MovieModel $_instance = null;
    private string $tblMovie;
    private string $tblMovieRating;
    ...
    public static function getMovieModel(): MovieModel
    {
    ...
    public function list_movie(): bool|array|int
    {
        ...
        while ($obj = $query->fetch_object()) {
            $movie = new Movie(stripslashes($obj->title), 
    ...
    public function view_movie($id): bool|Movie
    {
    ...
    //the update_movie method updates an existing movie in the database. Details of the movie are posted in a form. Return true if successful; false otherwise.
    public function update_movie($id): mysqli_result|bool
    {
        try {
            ...
            if (!filter_has_var(INPUT_POST, 'title') ||
                ...
                throw new DataMissingException(
                    "Missing movie fields. All movie fields are required.");
            }
            ...
            if ((!strtotime($release_date))) {
                throw new InvalidDateException("The movie release date is invalid.");
            }
            //execute the query
            $query = $this->dbConnection->query($sql);
            if (!$query) {
        ...
        }catch (DataMissingException|InvalidDateException|DatabaseExecution|Exception $e) {
            $view = new MovieError();
            $view->display($e->getMessage());
            return false;
        }
    ...
    public function search_movie($terms): bool|array|int
    {
    ...
    private function get_movie_ratings(): bool|array
    {
