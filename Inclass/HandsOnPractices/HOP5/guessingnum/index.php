...
<html lang="en">
    ...
    <body>
         <h2 style="font-size: 16pt">Guessing the Number</h2>
        <h3>This game is powered with <span style="color: red">AJAX</span>: a technology promising better user experiences.</h3>
        <p style="text-align: left"><strong>Instructions</strong>: This is a simple number guessing game. When the game starts,
        ...
        <p style="text-align: left"><strong>Important Note:</strong>Your browser must accept cookies for the game to work properly.
            The cookie is temporary and is destroyed when you exist the game.</p>
